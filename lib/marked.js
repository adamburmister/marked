...
InlineLexer.output = function(src, links, options) {
  ...
  var inline = new Klass(links, options);
...
Parser.prototype.parse = function(src) {
  var Klass = this.options.inlineLexer;
...
function marked(src, opt, callback) {
  if (callback || typeof opt === 'function') {
    ...
    try {
      tokens = options.lexer.lex(src, opt)
    } catch (e) {
      return callback(e);
    }
    ...
    var done = function(err) {
      ...
      try {
        out = options.parser.parse(tokens, opt);
      } catch (e) {
        err = e;
      }
...
marked.setOptions = function(opt) {
  ...
  if (!options.inlineLexer) {
    marked.defaults.inlineLexer = new InlineLexer(options);
  }
